...
void MaximizarMP(float Prob[100][100][100],long double Costos[100][100],int num_edos,int num_dec){
...
//MATRICES
	system("clear");
	cout<<"\n\n\tMatrices de transicion y Costos\n\n";
...
void MinimizarMP(float Prob[100][100][100], long double Costos[100][100], int num_edos, int num_dec){
	...
	do{
		...
		if(ind==num_edos){//FIN
			...
			cout<<"\n\n\tLA POLÍTICA NO ES OPTIMA. NUEVA POLITICA:\n\n";
			for(i=0;i<=num_edos-1;i++){
				cout<<"Tomar la decision "<<nPol[i]+1<<" en el estado "<<i+1<<"\n";
			}
			for(i=0;i<=num_edos-1;i++){
